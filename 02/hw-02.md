...
2. В Yandex Cloud создан сервисный аккаунт и ключ
...
4. На локальной машине сгенерирован новый ssh-ключ, открытая часть записана в переменную **vms_ssh_public_key**
