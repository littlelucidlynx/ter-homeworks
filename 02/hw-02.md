...
```preemptible = true``` - прерываемость виртуальной машины. В случае простоя в течение 24 часов виртуальная машина выключится. Для лабораторных работ, где не требуется постоянная доступность виртуальной машины, этот параметр экономит средства
